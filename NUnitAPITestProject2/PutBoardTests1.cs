...
namespace NUnitAPITestProject2
{
    class PutBoardTests1
    {
        ...
        public void PutBoardTest1()
        {
            ...
            IList<string> errorVar = new List<string>();

            // Assert json schema
            Assert.IsFalse(jsonObject.IsValid(jsonSchema, out errorVar));
